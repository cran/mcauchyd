mvrcd <- function(n, mu, Sigma, tol = 1e-6) {
  ...
  #' @aliases mvrcd
  #'
  #' @usage mvrcd(n, mu, Sigma, tol = 1e-6)
  ...
  #' 
  #' @details A sample from a MCD with parameters \eqn{\mu} and \eqn{\Sigma} can be generated using:
  #' \deqn{\displaystyle{X = \mu + \frac{Y}{\sqrt{u}}}}
  ...
  #' 
  #' @seealso \code{\link{mvdcd}}: probability density of a MCD.
  #'
  #' @examples
  #' mu <- c(0, 1, 4)
